...
import { ActivityIndicator, Alert, Animated, Dimensions, FlatList, Image, SafeAreaView, Text, TextInput, TouchableOpacity, TouchableWithoutFeedback, View } from 'react-native'
