        ...
        <ScrollView className="w-full px-4 pt-4 mb-20">
            ...
            <View className="flex-row items-start justify-between">
              <View className="w-2/3">
                ...
                <Text className="font-quicksand-semibold text-sm">
                  {job?.location} · {getEmploymentType(job?.employmentType)} · {getWorkArrangement(job?.setting)}
                </Text>
              ...
              {isAuthenticated && (
                <TouchableOpacity className="bg-green-500 rounded-full px-4 py-2 flex items-center justify-center">
                  <Text className={`font-quicksand-semibold text-sm`}>Check Match</Text>
                </TouchableOpacity>
              )}
            </View>
          ...
          <View className="flex-col gap-1">
            ...
            <View className="flex-col gap-2">
              ...
              {isLoadingCompany ? <ActivityIndicator /> : <ExpandableText text={company?.description || ""} />}
            </View>
        ...
        <BottomSheetView className="flex-1 bg-white">
          {isAuthenticated && user ? (
            ...
            <View className="flex flex-col justify-center items-center px-4 w-full gap-2">
              <Text className="font-quicksand-bold text-xl">Sign up or login to get started</Text>
