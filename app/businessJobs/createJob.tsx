...
const CreateJob = () => {
  ...
  const [createJobForm, setCreateJobForm] =
    useState<CreateJobForm>(defaultJobForm);
  ...
  const handleCreateJob = async () => {
    ...
    if (
      ...
      Alert.alert(
        "Error",
        "Please enter valid numbers for salary and experience"
      );
      setAddingJob(false);
      return;
    }
          ...
          <View className="p-4 flex flex-col gap-4">
            <View className="form-input">
              ...
              <TextInput
                ...
                onChangeText={(text) =>
                  setCreateJobForm({ ...createJobForm, title: text })
                }
            ...
            <View className="form-input">
              ...
              <TextInput
                ...
                onChangeText={(text) =>
                  setCreateJobForm({ ...createJobForm, location: text })
                }
            ...
            <View className="form-input">
              ...
              <TextInput
                ...
                onChangeText={(text) =>
                  setCreateJobForm({ ...createJobForm, description: text })
                }
              />
            </View>
            <View className="form-input">
              ...
              <TextInput
                ...
                onChangeText={(text) =>
                  setCreateJobForm({ ...createJobForm, experience: text })
                }
                ...
                setValue={(callback) => {
                  const value =
                    typeof callback === "function"
                      ? callback(createJobForm.employmentType)
                      : callback;
            ...
            <View className="flex flex-row gap-2">
              <View className="w-1/2 form-input">
                ...
                <TextInput
                  ...
                  onChangeText={(text) =>
                    setCreateJobForm({ ...createJobForm, minSalary: text })
                  }
                  className="form-input__input"
              ...
              <View className="w-1/2 form-input">
                ...
                <TextInput
                  ...
                  onChangeText={(text) =>
                    setCreateJobForm({ ...createJobForm, maxSalary: text })
                  }
                  className="form-input__input"
              ...
              <View className="form-input">
                ...
                <TextInput
                  ...
                  onSubmitEditing={(event) =>
                    handleAddTag(event.nativeEvent.text.trim())
                  }
                  ref={tagInputRef}
