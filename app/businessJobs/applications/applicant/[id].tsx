          ...
          <ScrollView className="p-4">
            ...
            <View>
              ...
              <View className="flex-row flex-wrap gap-3 mt-2">
                <TouchableOpacity className="bg-green-100 px-4 py-2 rounded-full" onPress={handleResumePress}>
                  <Text className="font-quicksand-medium text-black text-sm">View Resume</Text>
                </TouchableOpacity>
                {application?.coverLetterUrl && (
                  <TouchableOpacity className="bg-green-100 px-4 py-2 rounded-full" onPress={handleCoverLetterPress}>
              ...
              {showEducation &&
                userProfile?.education.map((edu) => (
                  <View key={edu.id} className="mb-2">
                    ...
                    <Text className="font-quicksand-medium text-sm text-gray-600">
                      {edu.institution} | {edu.fromYear} - {edu.toYear || "Present"}
                    </Text>
                  </View>
                ))}
            </View>
            ...
            {application?.status === "PENDING" && (
              ...
              >
                {makingShortListRequest ? (
                  ...
                  <Text className="font-quicksand-semibold text-lg">{isShortListed ? "Unshortlist" : "Shortlist"}</Text>
                )}
              </TouchableOpacity>
            )}
          </View>
