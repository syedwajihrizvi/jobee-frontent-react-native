...
const ApplyBottomSheet = ({selectedResume, setSelectedResume, openResumeDropdown, setOpenResumeDropdown, selectedCoverLetter, setSelectedCoverLetter, openCoverLetterDropdown, setOpenCoverLetterDropdown, userDocuments, isSubmittingApplication, handleSubmitApplication, closeSheet}: ApplyBottomSheetProps) => {
