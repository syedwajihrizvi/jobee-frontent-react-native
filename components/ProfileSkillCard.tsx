...
const ProfileSkillCard = ({skill, experience, onEditSkill}: {skill: string, experience: number, onEditSkill: () => void}) => {
  return (
    <View className="relative p-4 rounded-2xl bg-white shadow-sm border border-gray-100">
        ...
        <TouchableOpacity className="absolute -top-2 -right-2 rounded-full p-1" onPress={onEditSkill}>
